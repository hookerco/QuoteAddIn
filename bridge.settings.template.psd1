...
# workstation that runs install_service_host.ps1 picks it up as current-user env
# vars. Run the installer as the same normal interactive user that runs QuickBooks.
#
